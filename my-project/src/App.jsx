...
const UserCard = ({ name, email, age }) => {
  return (
    <div className="bg-black w-full text-white shadow-lg rounded-2xl p-6 border border-gray-700">
...
const Home = () => (
  <div className="text-center text-2xl font-semibold p-10 w-full  bg-gray-300">Welcome to User Dashboards</div>
);
